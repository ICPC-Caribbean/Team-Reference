/*
    Algorithm:
        Calculate cost of minimum spanning tree of points in the
        plane connected by rectilinear edges i.e. distance between
        a pair of points is manhattan distance.
