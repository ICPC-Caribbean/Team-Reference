...
// Tangent points from point to circle
// http://codeforces.com/group/3qadGzUdR4/contest/101707/problem/B
...
// Build center of circle that pass through (a, b, c)
...
/*
    ...
    Tested:
        ...
        http://lightoj.com/volume_showproblem.php?problem=1358
*/
#define x(_t) (xa + (_t) * a)
#define y(_t) (ya + (_t) * b)
