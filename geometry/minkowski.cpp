/*
    ...
    Tested:
        http://codeforces.com/problemset/problem/87/E

    Note:
        Polygons MUST be counterclockwise
        Polygon can be formed by point with integer coordinates (replace eps with 0)
*/
